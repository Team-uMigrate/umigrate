    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone_number",
                    models.CharField(blank=True, default="11234567890", max_length=15),
                ),
                (
                    "profile_photo",
                    models.ImageField(
                        blank=True, upload_to="images/user_profile_photos"
                    ),
                ),
                (
                    "background_photo",
                    models.ImageField(
                        blank=True, upload_to="images/user_background_photos"
                    ),
                ),
                (
                    "region",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[(0, "All"), (1, "Following"), (2, "None")], default=0
                    ),
                ),
                ...
                (
                    "currency",
                    models.PositiveSmallIntegerField(
                        choices=[(0, "CAD"), (1, "USD")], default=0
                    ),
                ),
                (
                    "language",
                    models.PositiveSmallIntegerField(
                        choices=[(0, "English"), (1, "French")], default=0
                    ),
                ),
