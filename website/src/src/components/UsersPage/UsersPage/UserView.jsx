      ...
      <div className="col-lg-10">
        ...
        >
          ...
          <Modal.Body style={secondBlock}>
            ...
            <h6>{props.currentUser.enrolled_program}, {props.currentUser.current_term}</h6>
          </Modal.Body>
          ...
          <Modal.Body>
            ...
            >
              <a class="" href="/x/">Experience</a>
              <a class="" href="/x/">Activites</a>
              <a class="" href="/x/">Interests</a>
            </div>
          </Modal.Body>
